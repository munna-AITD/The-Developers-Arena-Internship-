...
The Personal Finance Manager is a command-line based Python application designed to help users track and manage their daily expenses efficiently. 
The project allows users to record expenses, store them persistently using CSV files, generate financial reports, and back up data.
